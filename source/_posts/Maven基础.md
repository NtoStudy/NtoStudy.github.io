...
![image-20221130095316032](../images/Maven基础/image-20221130095316032.png)
...
![image-20221130104014162](../images/Maven基础/image-20221130104014162.png)

当使用maven进行项目依赖(jar包)管理，则很方便的可以解决这个问题。 我们只需要在maven项目的pom.xml文件中，添加一段如下图所示的配置即可实现。

![image-20220616001159531](../images/Maven基础/image-20220616001159531.png)  
...
![image-20221130212841973](../images/Maven基础/image-20221130212841973.png) 
...
![image-20221130222907628](../images/Maven基础/image-20221130222907628.png)
...
![image-20221130142100703](../images/Maven基础/image-20221130142100703.png)
...
![image-20221130142643255](../images/Maven基础/image-20221130142643255.png)

以上图中紫色框起来的部分属于项目对象模型，就是将我们自己的项目抽象成一个对象模型，有自己专属的坐标，如下图所示是一个Maven项目：

![image-20220616094113852](../images/Maven基础/image-20220616094113852.png)

> 坐标，就是资源(jar包)的唯一标识，通过坐标可以定位到所需资源(jar包)位置
>
> ![image-20221130230134757](../images/Maven基础/image-20221130230134757.png)



3). 依赖管理模型(Dependency)

![image-20221130143139644](../images/Maven基础/image-20221130143139644.png)

以上图中紫色框起来的部分属于依赖管理模型，是使用坐标来描述当前项目依赖哪些第三方jar包

![image-20221130174805973](../images/Maven基础/image-20221130174805973.png)
...
![image-20220616095633552](../images/Maven基础/image-20220616095633552.png)
...
![image-20220616100211209](../images/Maven基础/image-20220616100211209.png) 
...
![](../images/Maven基础/1-1669821012006.gif) 

解压缩后的目录结构如下：

![image-20220616100529868](../images/Maven基础/image-20220616100529868-1669794069698.png) 
...
![image-20221130231857537](../images/Maven基础/image-20221130231857537.png) 
...
![](../images/Maven基础/3.gif)

注意配置的位置，在<mirrors> ... </mirrors> 中间添加配置。如下图所示：

![image-20221130161346565](../images/Maven基础/image-20221130161346565.png)
...
![image-20220616102554143](../images/Maven基础/image-20220616102554143.png) 
...
![image-20220616103219646](../images/Maven基础/image-20220616103219646.png)

 

![image-20221130234731629](../images/Maven基础/image-20221130234731629.png)



2、设置IDEA使用本地安装的Maven，并修改配置文件及本地仓库路径

![](../images/Maven基础/image-20220616103302386.png)
...
![image-20220616111031057](../images/Maven基础/image-20220616111031057.png) 
...
>
> ![image-20220616111937679](../images/Maven基础/image-20220616111937679.png) 
...
![image-20221130184402805](../images/Maven基础/image-20221130184402805.png)  
...
![image-20221201120514644](../images/Maven基础/image-20221201120514644.png)



我们现在使用了maven，当项目中需要使用logback-classic时，只需要在pom.xml配置文件中，添加logback-classic的依赖坐标即可。

![image-20221201113659400](../images/Maven基础/image-20221201113659400.png)
...
![image-20220616115445812](../images/Maven基础/image-20220616115445812.png) 
...
![image-20221201115801806](../images/Maven基础/image-20221201115801806.png)
...
![image-20221201141929240](../images/Maven基础/image-20221201141929240.png)

- 使用排除依赖后

![image-20221201142501556](../images/Maven基础/image-20221201142501556.png)
...
![image-20221201135142706](../images/Maven基础/image-20221201135142706.png)

如果希望限制依赖的使用范围，可以通过<scope>标签设置其作用范围。

![image-20220616123806894](../images/Maven基础/image-20220616123806894.png) 
...
![image-20221201140140947](../images/Maven基础/image-20221201140140947.png)
...
![](../images/Maven基础/image-20220616124015567.png)
...
![image-20220616124348972](../images/Maven基础/image-20220616124348972.png) 
...
![image-20221201151340340](../images/Maven基础/image-20221201151340340.png)
...
![image-20221201161957301](../images/Maven基础/image-20221201161957301.png) 



compile：

![image-20221201163711835](../images/Maven基础/image-20221201163711835.png)



test：

![image-20221201164627403](../images/Maven基础/image-20221201164627403.png)



package：

![image-20221201165801341](../images/Maven基础/image-20221201165801341.png)



install：

![image-20221201170830837](../images/Maven基础/image-20221201170830837.png)



clean：

![image-20221201171529382](../images/Maven基础/image-20221201171529382.png)
...
![image-20221201172210253](../images/Maven基础/image-20221201172210253.png)

![image-20221201172914648](../images/Maven基础/image-20221201172914648.png) 
...
![1537786634456](../images/Maven基础/1537786634456-1582625518984.png)
...
![lastUpdate](../images/Maven基础/lastUpdated-1582625518983.png)
...
![image-20221214154949482](../images/Maven基础/image-20221214154949482.png) 

2). 在上面的bat文件上**右键---》编辑** 。修改文件：

![image-20221214154559817](../images/Maven基础/image-20221214154559817.png) 
