...
```
执行一次上面代码：  
![在这里插入图片描述](../images/尚品汇总结/1.png)
多次执行出现警告：  
![在这里插入图片描述](../images/尚品汇总结/2.png)
...
![在这里插入图片描述](../images/尚品汇总结/14.png)
通过前面描述的代码我们实现了父子通信，即将floorList分发给Floor组件。下图为Floor组件信息
![在这里插入图片描述](../images/尚品汇总结/15.png)
...
输入框实在Header组件中的
![在这里插入图片描述](../images/尚品汇总结/18.png)
header和search组件是兄弟组件，要实现该操作就要通过兄弟组件之间进行通信完成。
![在这里插入图片描述](../images/尚品汇总结/19.png)
...
SearchSelector组件有两个属性也会生成面包屑，分别为品牌名、手机属性。如下图所示![在这里插入图片描述](../images/尚品汇总结/20.png)
...
![在这里插入图片描述](../images/尚品汇总结/21.png)
图标是iconfont网站的图标，通过引入在线css的方式引入图标
![在这里插入图片描述](../images/尚品汇总结/22.png)
...
![在这里插入图片描述](../images/尚品汇总结/28.png)
**警告**
![在这里插入图片描述](../images/尚品汇总结/29.png)
图中内容如下：
...
![在这里插入图片描述](../images/尚品汇总结/30.png)
dist就是我们打包好的项目文件
![在这里插入图片描述](../images/尚品汇总结/31.png)
